...
\score {
  <<
    \new Staff = "1" \with {
      instrumentName = \markup { \bold "Solo" }
    }
    <<
        \clef treble
        \new Voice = solo {
      ...
      \new Lyrics \lyricsto solo \loiPhienKhucSoloMot
      \new Lyrics \lyricsto solo \loiPhienKhucSoloHai
      \new Lyrics \lyricsto solo \loiPhienKhucSoloBa
    >>
  \new ChoirStaff \with {
    instrumentName = \markup { \bold "Coro" }
  }
  <<
    \new Staff = "2" \with {
