...
loiPhienKhucBasMot = \lyrics {
  \set stanza = "1."
  Ngài đã sai tôi đi loan báo Tin Mừng
  ...
  nào người người hãy nắm tay hát mừng,
  hát mừng, nắm tay hát mừng phút kết duyên.
}
